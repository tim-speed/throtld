...
const database = module.exports = {
  ...
  getApps(ownerId) {
    ...
    return Object.values(database.apps).filter(app => app.ownerId === ownerId)
      .map(app => app.appId);
  },
  /**
   * Internal use only, don't return data to user
   */
  _getApp(appId) {
    return database.apps[appId];
  },
